...
(function() {
  ...
  Nex.Widgets.Image = (function(_super) {
    ...
    Image.prototype.preload = function(width, height) {
      var assetRatio, css, dpr, img, servingSize, wrapperRatio;
      if (width == null) {
        width = this.width;
      }
      if (height == null) {
      ...
      this.log('preloading :', width, this.width, height, this.height);
      ...
      if (width === this.width || width === 'auto' && height === this.height || height === 'auto') {
        this.log('IfElse Block: ', width, this.width, height, this.height);
      ...
      this.log('servingURl', this.servingUrl);
    ...
    Image.prototype.imgLoaded = function() {
      ...
      this.delay(this.loadedClass, 10);
      this.trigger('loaded');
