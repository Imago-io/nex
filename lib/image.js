...
(function() {
  ...
  Nex.Widgets.Image = (function(_super) {
    ...
    function Image() {
      ...
      if (!this.src) {
        throw new Error('image widget rquires src');
      }
      if (!this.resolution) {
        throw new Error('image widget rquires resolution');
      }
    ...
    Image.prototype.preload = function() {
      ...
      if (this.sizemode === 'crop') {
        ...
        this.log('ratios', assetRatio, wrapperRatio);
        if (assetRatio < wrapperRatio) {
          servingSize = Math.round(Math.max(height, height * assetRatio));
        } else {
          servingSize = Math.round(Math.max(width, width / assetRatio));
      ...
      this.log('servingSize ', servingSize);
