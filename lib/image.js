...
(function() {
  ...
  Nex.Widgets.Image = (function(_super) {
    ...
    function Image() {
      ...
      this.log('constructor: ', this.width, this.height);
    ...
    Image.prototype.preload = function(options) {
      ...
      if (typeof this.initialWidth === 'number' && typeof this.initialHeight === 'number') {
        this.log('fixed size', this.width, this.height);
        ...
        this.el.width(this.width);
        this.log('fit height', this.width, this.height);
        ...
        this.log('both auto', this.width, this.height);
      } else {
        this.width = parseInt(this.el.css('width'));
        this.height = parseInt(this.el.css('height'));
        this.log('fit el', this.width, this.height, this.initialWidth, this.initialHeight);
      }
    ...
    Image.prototype.calcMediaSize = function(options) {
      ...
      this.log('calcMediaSize: @width, @height', this.width, this.height);
