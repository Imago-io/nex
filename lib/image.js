...
(function() {
  ...
  Nex.Widgets.Image = (function(_super) {
    ...
    function Image() {
      ...
      this.el.addClass("" + this["class"] + " " + this.align);
      if (this.style) {
    ...
    Image.prototype.onResize = function() {
      return this.image.css(this.calcMediaSize());
    };
    ...
    Image.prototype.imgLoaded = function() {
      var css;
      css = this.calcMediaSize();
      css.backgroundImage = "url(" + this.servingUrl + ")";
      this.image.css(css);
      this.delay(function() {
    ...
    Image.prototype.calcMediaSize = function(options) {
      var assetRatio, backgroundSize, css, key, value, wrapperRatio;
      for (key in options) {
        value = options[key];
        this[key] = value;
      }
      ...
      if (this.sizemode === 'crop') {
        ...
        if (assetRatio > wrapperRatio) {
          ...
          css.height = "" + (this.width / assetRatio) + "px";
          backgroundSize = "100% auto";
        } else {
          css.width = "" + (this.height * assetRatio) + "px";
