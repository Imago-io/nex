    ...
    Image.prototype.preload = function() {
      ...
      if (this.sizemode === 'crop') {
        ...
        if (assetRatio < wrapperRatio) {
          servingSize = Math.min(Math.round(width / assetRatio) * dpr, this.maxSize);
        } else {
          servingSize = Math.min(Math.round(height * assetRatio) * dpr, this.maxSize);
        }
      } else {
        servingSize = Math.min(Math.min(width, height) * dpr, this.maxSize);
      }
      ...
      this.servingUrl = "" + this.src + "=s" + this.servingSize;
