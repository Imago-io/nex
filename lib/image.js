...
(function() {
  ...
  Image = (function(_super) {
    ...
    Image.prototype.preload = function() {
      ...
      width = this.width * this.scale || this.el.width();
      height = this.height * this.scale || this.el.height();
      if (width) {
      ...
      this.serving_url += "=s" + (Math.min(Math.max(width, height) * dpr, 1600));
      if (Number(width)) {
        this.serving_url += "-w" + (width * dpr);
      }
      if (Number(height)) {
        this.serving_url += "-h" + (height * dpr);
      }
    ...
    Image.prototype.imgLoaded = function() {
      ...
      this.image.css(css);
      return this.delay(this.loadedClass, 10);
    };
