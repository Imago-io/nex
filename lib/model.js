...
(function() {
  var Asset, Collection, Generic, Image, Proxy, Search, Setting, Video, models, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6,
  ...
  Asset = (function(_super) {
    ...
    Asset.get_model = function(id_or_kind) {
      return models[id_or_kind] || models[this.id_to_kind(id_or_kind)];
    };
