...
(function() {
  ...
  Asset = (function(_super) {
      ...
      if (Spine.isArray(value)) {
        normalized = (function() {
          ...
          for (_i = 0, _len = value.length; _i < _len; _i++) {
            val = value[_i];
            _results.push(Nex.Utils.normalize(val));
          }
          return _results;
        })();
        for (_i = 0, _len = normalized.length; _i < _len; _i++) {
          val = normalized[_i];
          if (__indexOf.call(value, val) < 0) {
            value.push(val);
          }
        }
      }
    ...
    Asset.prototype.filterOptions = function(keyname, value) {
      var key, obj, opts, variant, variants, _i, _len, _ref, _ref1, _ref2;
      ...
      for (_i = 0, _len = variants.length; _i < _len; _i++) {
        ...
        for (key in _ref) {
          ...
          opts.mapping[obj.value] = ((_ref2 = variant.meta.stock) != null ? _ref2.value : void 0) || 0;
        }
      }
      return opts;
    };
  ...
  Setting = (function(_super) {
    ...
    Setting.setSessionData = function() {
      ...
      Nex.currencies = (_ref = this.findByName('currencies')) != null ? _ref.value : void 0;
      Nex.ipaddress = (_ref1 = this.findByName('ipaddress')) != null ? _ref1.value : void 0;
      Nex.country = (_ref2 = this.findByName('country')) != null ? _ref2.value : void 0;
      Nex.city = (_ref3 = this.findByName('city')) != null ? _ref3.value : void 0;
      Nex.region = (_ref4 = this.findByName('region')) != null ? _ref4.value : void 0;
