...
(function() {
  ...
  Asset = (function(_super) {
    ...
    Asset.prototype.price = function(currency, discounted) {
      var priceValue, _ref, _ref1;
      if (discounted == null) {
        discounted = false;
      }
      priceValue = (_ref = this.variants[0]) != null ? _ref.meta.price.value[currency] : void 0;
      if (discounted) {
        priceValue = (_ref1 = this.variants[0]) != null ? _ref1.meta.discounted.value[currency] : void 0;
      }
      return Nex.Utils.toPrice(priceValue, currency);
    };
  ...
  Setting = (function(_super) {
    ...
    Setting.setSessionData = function() {
      ...
      Nex.latlong = this.findByName('latlong').value;
      Nex.city = this.findByName('city').value.toUpperCase();
      Nex.region = this.findByName('region').value.toUpperCase();
      return Nex.currency = this.currency();
    };
