  ...
  Setting = (function(_super) {
    ...
    Setting.setSessionData = function() {
      ...
      return $.ajax({
        ...
        return Nex.log('fetch error for geoip');
      });
    };
