...
(function() {
  ...
  Asset = (function(_super) {
    ...
    Asset.prototype.price = function(currency, discounted, decimals) {
      ...
      priceValue = ((_ref = this.variants[0]) != null ? _ref.meta.price.value[currency] : void 0) || this.getMeta('price', 0);
      if (discounted) {
        priceValue = ((_ref1 = this.variants[0]) != null ? _ref1.meta.discounted.value[currency] : void 0) || this.getMeta('discounted', 0);
      }
