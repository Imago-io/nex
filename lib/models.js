...
(function() {
  ...
  Asset = (function(_super) {
    ...
    Asset.prototype.getMeta = function(field, fallback) {
      ...
      if ((_ref1 = this.meta[field]) != null ? _ref1.value.hasOwnProperty('value') : void 0) {
        return ((_ref2 = this.meta[field].value) != null ? _ref2.value : void 0) || fallback;
      }
      return ((_ref3 = this.meta[field]) != null ? _ref3.value : void 0) || fallback;
    };
  ...
  Generic = (function(_super) {
    ...
    Generic.configure('Generic', 'kind', 'name', 'meta', 'serving_url', 'path', 'date_created', 'date_modified', 'resolution', 'normname', 'canonical');
  ...
  CartItem = (function(_super) {
    ...
    CartItem.addToCart = function(itemid, quantity, options) {
      ...
      if (existing.length) {
        item = existing[0];
        if ((item != null ? item.size : void 0) === (options != null ? options.size : void 0) && (item != null ? item.color : void 0) === (options != null ? options.color : void 0)) {
