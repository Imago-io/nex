...
(function() {
  ...
  Nex.Panel = {
    getData: function(query, options) {
      var abortable, ajax, fetchassets, i, lean, len, q, ref;
      if (options == null) {
        options = {};
      }
      if (!query) {
      ...
      fetchassets = options.fetchAssets === void 0 ? true : options.fetchAssets;
      ajax = options.ajax === void 0 ? true : options.ajax;
      lean = options.lean === void 0 ? false : options.lean;
      ref = this.query;
      for (i = 0, len = ref.length; i < len; i++) {
        q = ref[i];
        this.promises.push(Nex.Models.Asset.get(q, abortable, fetchassets, ajax, lean).done((function(_this) {
          return function(result) {
            if (!result.id && result.count === 0) {
              return;
            }
    ...
    getRelated: function(query, options) {
      ...
      for (i = 0, len = ref.length; i < len; i++) {
        ...
        this.relpromises.push(Nex.Models.Asset.get(q, this.relquery.length > 1 || !options.abortable ? false : void 0).done((function(_this) {
          return function() {
            var ref1;
            return (ref1 = _this.related).push.apply(ref1, arguments);
          };
        })(this)).fail((function(_this) {
          return function() {
