  ...
  Nex.Panel = {
    getData: function(query) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        q = _ref[_i];
        this.promises.push(Nex.Models.Asset.get(q, this.query.length > 1 ? false : void 0).done((function(_this) {
          return function() {
            var _ref1;
    ...
    getRelated: function(query) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        q = _ref[_i];
        this.relpromises.push(Nex.Models.Asset.get(q).done((function(_this) {
          return function() {
            var _ref1;
