...
(function() {
  ...
  Nex.Pusher = {
    ...
    parse_data: function(data, options) {
      var adds, asset, assetchng, deletes, existing, i, id, item, orderchange, tgllist, _i, _j, _len, _len1, _ref, _results;
      if (options == null) {
        options = {
          ajax: false
        };
      ...
      for (_i = 0, _len = data.length; _i < _len; _i++) {
        ...
        if (tgllist != null) {
          for (_j = 0, _len1 = tgllist.length; _j < _len1; _j++) {
            id = tgllist[_j];
            if ((_ref = this.globalFind(id)) != null) {
              _ref.trigger('visibility.tile');
            }
          }
        }
        if (deletes != null ? deletes.length : void 0) {
          item.trigger('delete.assets', deletes);
        }
    ...
    _swith_ids: function(message) {
      ...
      asset = this.globalFind(message.from_id);
