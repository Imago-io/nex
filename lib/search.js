      ...
      getAssetsDone = (function(_this) {
        return function(assets) {
          if (result.kind === 'Collection') {
            ...
            if (_this.page) {
              result.next = result.items.length + _this.offset < result.assets.length ? _this.page + 1 : null;
    ...
    getAssets: function(collection, params) {
      ...
      if (collection.kind === 'Collection') {
        ...
        if (Object.keys(params).length === 1 && params.hasOwnProperty('page')) {
          params.pagesize = ((_ref = collection.meta.pagesize) != null ? _ref.value : void 0) || 50;
