      ...
      variant = _.filter(this.asset.variants, (function(_this) {
        return function(variant) {
          ...
          for (key in ref) {
            ...
            if (String(variant.meta[key].value).toLowerCase() !== String(value).toLowerCase()) {
              status = false;
            }
          }
          return status;
    ...
    Option.prototype.checkOption = function(option) {
        ...
        return function(variant) {
          ...
          if (!_.isEmpty(_this.item)) {
            ...
            for (key in ref) {
              ...
              key = Nex.Utils.singularize(key);
              if (String(variant.meta[name].value).toLowerCase() !== option.toLowerCase()) {
                passed = false;
              }
            }
          }
      ...
      if (variants.length === 0) {
        ...
        for (i = 0, len = variants.length; i < len; i++) {
          variant = variants[i];
          totalStock += Number((ref = variant.meta.stock) != null ? ref.value : void 0) || 0;
