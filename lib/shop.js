...
(function() {
  ...
  Nex.Widgets.Shop = (function(_super) {
    ...
    Shop.prototype.render = function() {
      var opt, variant, _i, _len, _ref, _ref1, _results;
      this.clear();
      variant = this.getVariant();
      this.html(this.tmpl({
        asset: this.asset,
        variant: variant,
        onSale: variant && ((_ref = variant.meta.discounted) != null ? _ref.value[Nex.currency] : void 0) ? variant.meta.discounted : false,
  ...
  Option = (function(_super) {
    ...
    Option.prototype.checkOption = function(option) {
      var onSale, status, totalStock, variant, variants, _i, _len, _ref, _ref1;
      status = {
        notAvailable: false,
        soldOut: false,
        onSale: false
      ...
      if (variants.length === 0) {
        ...
        for (_i = 0, _len = variants.length; _i < _len; _i++) {
          variant = variants[_i];
          totalStock += (((_ref = variant.meta.stock) != null ? _ref.value : void 0) != null) || 0;
          if (!(variant.meta.discounted && ((_ref1 = variant.meta.discounted) != null ? _ref1.value[Nex.currency] : void 0) > 0)) {
            onSale = false;
            continue;
          }
        }
