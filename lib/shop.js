...
(function() {
  ...
  Option = (function(_super) {
    ...
    Option.prototype.checkOption = function(option) {
      var onSale, status, totalStock, variant, variants, _i, _len, _ref;
      status = {
        notAvailable: false,
        soldOut: false,
        onSale: false
      ...
      if (variants.length === 0) {
        ...
        for (_i = 0, _len = variants.length; _i < _len; _i++) {
          ...
          if (!(variant.meta.discounted && ((_ref = variant.meta.discounted) != null ? _ref.value[Nex.currency] : void 0) > 0)) {
            onSale = false;
            continue;
          }
        }
