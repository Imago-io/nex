...
(function() {
  var Option, ShopWidget,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  ShopWidget = (function(_super) {
    __extends(ShopWidget, _super);

    ShopWidget.prototype.logPrefix = '(App) ShopWidget: ';

    ShopWidget.prototype.className = 'shopWidget';

    ShopWidget.prototype.elements = {
      '.wrapper': 'wrapper',
      '.error': 'error',
      '.price': 'price'
    };

    ShopWidget.prototype.events = {
      'tap .add': 'addToCart'
    };
    ...
    function ShopWidget() {
      ...
      ShopWidget.__super__.constructor.apply(this, arguments);
    ...
    ShopWidget.prototype.add = function(controller) {
      this.controllers.push(controller);
      return this.wrapper.append(controller.el);
    };

    ShopWidget.prototype.update = function(params) {
      this.item[params.key] = params.value;
      return this.render();
    };

    ShopWidget.prototype.getVariant = function() {
      var variant;
    ...
    ShopWidget.prototype.closeOptions = function(option) {
    ...
    ShopWidget.prototype.clear = function() {
    ...
    ShopWidget.prototype.release = function() {
      this.clear();
      return ShopWidget.__super__.release.apply(this, arguments);
    };

    ShopWidget.prototype.addToCart = function() {
