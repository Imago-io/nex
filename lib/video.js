...
(function() {
  ...
  Nex.Widgets.Video = (function(_super) {
    ...
    function Video() {
      ...
      this.html('<div class="wrapper"><div class="spin"></div><div class="spin2"></div><a class="playbig icon-play" /></div>');
    ...
    Video.prototype.resize = function() {
      ...
      if (this.sizemode === 'crop') {
        width = this.width || this.wrapper.width();
        height = this.height || this.wrapper.height();
        ...
        width = this.width || this.wrapper.parent().width();
        height = this.height || this.wrapper.parent().height();
        wrapperRatio = width / height;
        if (assetRatio > wrapperRatio) {
          this.videoEl.el.css({
            width: '100%',
