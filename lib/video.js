...
(function() {
  ...
  Nex.Widgets.Video = (function(_super) {
    ...
    Video.prototype.resize = function() {
      ...
      this.log('resize assetRatio', this.resolution, assetRatio);
      if (this.sizemode === 'crop') {
        ...
        wrapperRatio = width / height;
        if (assetRatio > wrapperRatio) {
          this.log('full width', width, parseInt(width / assetRatio, 10));
          this.videoEl.el.css({
            width: '100%',
          ...
          this.log('full height', parseInt(height * assetRatio, 10), height);
          this.videoEl.el.css({
