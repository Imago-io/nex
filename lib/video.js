...
(function() {
  var Controls, Video, VideoElement,
  ...
  Video = (function(_super) {
    ...
    function Video() {
      ...
      w = $(window).on('resize', this.resize);
  ...
  VideoElement = (function(_super) {
    ...
    VideoElement.prototype.loadSources = function() {
      ...
      for (i = _i = 0, _len = _ref.length; _i < _len; i = ++_i) {
        ...
        src = "http://" + Spine.settings.tenant + ".imagoapp.com/assets/api/play_redirect?uuid=" + this.player.uuid + "&codec=" + format.codec + "&quality=hd&max_size=" + format.size;
        srcEl = $('<source />', {
          src: src,
