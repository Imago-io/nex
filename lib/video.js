...
(function() {
  ...
  Nex.Widgets.Video = (function(_super) {
    ...
    function Video() {
      ...
      if (typeof this.width === 'number' && typeof this.height === 'number') {
        ...
        this.height = parseInt(this.width / this.assetRatio);
        this.el.height(this.height);
      } else if (this.width === 'auto' && typeof this.height === 'number') {
        this.width = parseInt(this.height * this.assetRatio);
        this.el.css({
          width: this.width,
          height: this.height
        });
        ...
        this.height = this.width / this.assetRatio;
        this.el.height(parseInt(this.height));
      } else {
        this.width = parseInt(this.el.css('width'));
        this.height = parseInt(this.el.css('height'));
        this.log('fit width', this.width, this.height);
      }
      this.log(this.width, this.height);
      this.window = $(window);
        ...
        if (this.assetRatio < wrapperRatio) {
          if (Nex.Utils.isiOS()) {
            ...
            if (this.align === 'center center') {
              s.top = '50%';
              s.left = 'auto';
              s.marginTop = "-" + (width / this.assetRatio / 2) + "px";
              s.marginLeft = "0px";
            }
          }
          this.log(this.video.el);
          this.video.el.css(s);
          ...
          if (Nex.Utils.isiOS()) {
            ...
            if (this.align === 'center center') {
              ...
              s.left = '50%';
              s.marginTop = "0px";
              s.marginLeft = "-" + (height * this.assetRatio / 2) + "px";
            }
          }
          this.log(this.video.el);
          this.video.el.css(s);
  ...
  Controls = (function(_super) {
    ...
    Controls.prototype.onSeek = function(e) {
      ...
      return this.player.video.seek(value);
    };
