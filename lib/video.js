...
(function() {
  ...
  Nex.Widgets.Video = (function(superClass) {
    ...
    function Video() {
      ...
      this.activateControls = bind(this.activateControls, this);
      this.setupPosterFrame = bind(this.setupPosterFrame, this);
  ...
  VideoElement = (function(superClass) {
    extend(VideoElement, superClass);
    ...
    function VideoElement() {
      this.onended = bind(this.onended, this);
      this.onplay = bind(this.onplay, this);
      this.onpause = bind(this.onpause, this);
      this.ondurationchange = bind(this.ondurationchange, this);
      this.oncanplay = bind(this.oncanplay, this);
    ...
    VideoElement.prototype.loadSources = function() {
      var codec, format, i, j, len, ref, results, src, srcEl;
      if (!this.player.uuid) {
        return;
      }
      ...
      for (i = j = 0, len = ref.length; j < len; i = ++j) {
        ...
        results.push(this.el.append(srcEl));
      }
      return results;
    };
  ...
  Controls = (function(superClass) {
    ...
    function Controls() {
      this.doDelayed = bind(this.doDelayed, this);
      this.onfullscreenchange = bind(this.onfullscreenchange, this);
      this.onEnterFullScreen = bind(this.onEnterFullScreen, this);
      this.onVolumeChnage = bind(this.onVolumeChnage, this);
      this.toggleSize = bind(this.toggleSize, this);
      this.onSeek = bind(this.onSeek, this);
      this.onvolumeupdate = bind(this.onvolumeupdate, this);
